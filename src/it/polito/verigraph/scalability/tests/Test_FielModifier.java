...
public class Test_FielModifier {
    ...
    public  Test_FielModifier(){
        ...
        NetContext nctx = new NetContext (ctx,new String[]{"a", "b", "modifier1"},
                                                new String[]{"ip_a", "ip_b", "ip_modifier1"});
        ...
        rt2.add(new Tuple<DatatypeExpr,NetworkObject>(nctx.am.get("ip_a"), modifier1));
        rt2.add(new Tuple<DatatypeExpr,NetworkObject>(nctx.am.get("ip_modifier1"), modifier1));
        ...
        packet.setOptions(10);
        
        modifier1.installFieldModifier(Optional.empty());
    ...
    {
        Test_FielModifier model = new Test_FielModifier();
        model.resetZ3();
