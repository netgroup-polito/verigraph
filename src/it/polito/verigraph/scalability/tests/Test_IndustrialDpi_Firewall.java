...
import it.polito.verigraph.mcnet.netobjs.PolitoIndustrialIDS;
...
public class Test_IndustrialDpi_Firewall {

    public Checker check;
    public Context ctx;
    public PolitoEndHost a;
    public PolitoEndHost b;
    public PolitoIndustrialIDS dpi1;
    public AclFirewall fw;

    public  Test_IndustrialDpi_Firewall(){
        ctx = new Context();
        ...
        dpi1 = new PolitoIndustrialIDS(ctx, new Object[]{nctx.nm.get("dpi1"), net, nctx});
        ...
        //Configuring middleboxes (forbidden action)
        int[] s = { 1,2,3} ;
        dpi1.installIDS(s);
        ...
        packet.setFunctionCode(7);
        packet.setBody(7);
        packet.setProto(nctx.MODBUS_REQUEST);
        packet.setIp_dest(nctx.am.get("ip_b"));
        
        a.installAsModbusClient(nctx.am.get("ip_b"), packet);
        b.installAsModbusServer(new PacketModel());
    ...
    {
        Test_IndustrialDpi_Firewall model = new Test_IndustrialDpi_Firewall();
        model.resetZ3();
